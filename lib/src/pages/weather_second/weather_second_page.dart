...
class WeatherSecondPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final weather = ref.watch(weatherAsyncSecondProvider); // AsyncValue<String>
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () {
              _selectedIndex = 1;
              // AsyncLoading  -->  AsyncData 또는 AsyncError 순서로 동작함.
              ref.invalidate(cityNotiProvider);
              // AsincData 또는 AsyncError 의 isLoading: true + isRefeshing: true
              // --> AsyncData 또는 AsyncError isLoading: false + isRefeshing: false 순서로 동작함.
              ref.invalidate(weatherAsyncSecondProvider);
            },
          ),
        ],
      ),
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return OutlinedButton(
      ...
      onPressed: () {
        ...
        _selectedIndex++;
        ref.read(cityNotiProvider.notifier).changeCity(city);
      },
    );
  }
}
